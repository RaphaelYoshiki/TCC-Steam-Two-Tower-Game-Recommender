...
def main():
    ...
    while len(apps_remaining_deque) > 0:
        ...
        try:
            ...
            if appdetails_req.status_code == 200 and appreviews_req.status_code == 200 and appusertags_req.status_code == 200:
            ...
            elif appdetails_req.status_code == 429 or appreviews_req.status_code == 429 or appusertags_req.status_code == 429:
            ...
            elif appdetails_req.status_code == 403 or appreviews_req.status_code == 403 or appusertags_req.status_code == 403:
                ...
                print_log("ERROR: Details status code:", appdetails_req.status_code, " Reviews status code:", appreviews_req.status_code, " Usertags status code:", appusertags_req.status_code)
